...
const TrackOrder = () => {
  ...
  useEffect(() => {
    const checkoutId = params.get("checkouId") || "";
    const orderId = params.get("orderId") || "";

    if (!checkoutId || !orderId) {
      setError("Missing required parameters: checkoutId and orderId");
      setLoading(false);
      return;
    }
    ...
    fetchOrder();
    console.log("Triggered panchoda ");
  }, []);

  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-secondary/30 to-dark justify-center bg-gradient-to-br from-dark via-dark/80 to-primary/10 px-4 py-10">
