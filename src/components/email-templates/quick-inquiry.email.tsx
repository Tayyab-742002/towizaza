...
interface QuickInquiryEmailProps {
  name: string;
  email: string;
  subject: string;
  message: string;
...
export const QuickInquiryEmail: React.FC<QuickInquiryEmailProps> = ({
  name,
  email,
  subject,
  message,
    ...
    >
        ...
        <table style={{ width: "100%", marginBottom: 20, fontSize: 15 }}>
          <tbody>
            ...
            <tr>
              ...
              <td style={{ color: colors.dark }}>{subject}</td>
            </tr>
          </tbody>
        </table>
        <div
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: 12, color: "#aaa" }}>
          This message was sent from the quick inquiry form on your website.
        </p>
      </div>
    </div>
  );
...
export default QuickInquiryEmail;
