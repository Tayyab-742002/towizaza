...
export default function PressKitSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/quick-inquiry-form", {
        method: "POST",
        headers: {
      ...
      setFormData({ name: "", email: "", subject: "media", message: "" });
    } catch (error: any) {
      setStatus({
        loading: false,
        success: false,
  ...
  const pressResources = [
    {
      ...
      description:
        "Download the complete artist biography, approved for press and media use.",
      icon: (
        <svg
    ...
    },
    {
      title: "Press Photos",
      description:
        "High-resolution promotional images for publication and media coverage.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    },
    {
      title: "Brand Assets",
      description:
        "Logos, color palettes, and typography guidelines for consistent brand representation.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      description:
        "Technical specifications and requirements for live performances and venue setup.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <div className="bg-dark/40 backdrop-blur-md border border-light/5 rounded-xl p-8 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-6 text-light relative z-10">
                Quick Inquiry
              </h3>
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-light/70 mb-2 text-sm"
                    >
                      Name
                    </label>
                    <input
